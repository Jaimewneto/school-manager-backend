...
import { PartyPhoneModel } from "@database/models/PartyPhoneModel";

export const getPartyPhoneScopedFilters = (): Clause | undefined => {
    ...
    const conditions: Condition<PartyPhoneModel>[] = [];
