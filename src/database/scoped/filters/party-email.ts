...
import { PartyEmailModel } from "@database/models/PartyEmailModel";

export const getPartyEmailScopedFilters = (): Clause | undefined => {
    ...
    const conditions: Condition<PartyEmailModel>[] = [];
